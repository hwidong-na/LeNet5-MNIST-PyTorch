...
def draw(loader, prefix, n=2, interval=100):
    fig = plt.figure(figsize=(n+1, CLS))
...
if __name__ == '__main__':
    ...
    uloader = UnlabeledDataLoader(train_ood, batch_size=batch_size*4, max_spl_per_cls=6000, nDataLoaderThread=5, gSize=n_s+n_q, maxQueueSize=500)
    ...
    draw(uloader, "udata", n=n_s+n_q, interval=100)
    ...
    model = SelfTaughtModel(uloader).cuda()
    epoch = 50
    interval = 5
